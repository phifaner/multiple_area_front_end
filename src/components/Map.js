...
//   latitude: 28.01,
//   longitude: 1120.65,
//   cellData: 'hhttp://localhost:3000/data/bs_wz_full.csv',
...
class MapPage extends React.Component {
  ...
  componentDidMount() {
    ...
    fetchPolyfill().then(async () => {
      ...
      const data = await d3.csv(SGSetting.cellData);
      ...
      map.on('click', 'voronoi', () => {
        ...
        const { setCells, setMap, setCellMap } = this.context;
        setCellMap(cellMap);
        setMap(map);
