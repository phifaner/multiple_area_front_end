...
const ClusterPattern = ({className, ...rest }) => {
  ...
  return (
    ...
    <CardHeader title="CLUSTER Pattern" titleTypographyProps={{ variant: 'h5' }} />
    <Divider />
...
ClusterPattern.propTypes = {
  className: PropTypes.string
};

export default ClusterPattern;
